...
///
/// This templated C++ version by Greg Douglas at Auran (http://www.auran.com)
/// Modified by Hermano Lustosa to allow run-time multidimensional support.
/// Possibly slower, but more flexible.
///
